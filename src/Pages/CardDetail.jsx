  ...
  return (
    <div className='container-fluid'>
      <div className='col-10 mx-auto text-center'>
        <div className='card w-75 shadow mx-auto bg-warningcard mt-5 rounded-5 pb-3' style={{ border: "none", maxHeight: "900px" }}>
            ...
            <div className='pt-5 mx-auto text-start d-flex flex-column align-items-center'>
              ...
              <div className='d-flex w-100 ms-5'>
                ...
                <div className='card-text ms-5 mt-5'>
                  ...
                  <p className='mb-2'>Microchip: {selectedCat.microchip}</p>
