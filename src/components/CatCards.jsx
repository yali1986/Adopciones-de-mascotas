      ...
      {cats.map(cat => (
        <div key={cat.id} className="card shadow-sm cat-card rounded-4 border border-light p-2" onClick={() => handleMoreInfoClick(cat)} style={{ border: "none", cursor: "pointer", width: "300px" }}>
          <div className='card-body text-center'>
            <div className='ratio ratio-4x3' style={{ background: `url('${cat.image}')`, backgroundSize: "cover", backgroundPosition: "center", clipPath: "polygon(50% 0%, 100% 8%, 98% 100%, 2% 100%, 0 8%)" }}></div>
